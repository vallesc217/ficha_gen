...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Genetica Avicola</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="<?php echo $active_facturas;?>"><a href="facturas.php"><i class='glyphicon glyphicon-list-alt'></i> Fichas <span class="sr-only">(current)</span></a></li>
        <li class="<?php echo $active_productos;?>"><a href="productos.php"><i class='glyphicon glyphicon-barcode'></i> Productos</a></li>
		<!--<li class="<?php echo $active_pagos;?>"><a href="pagos.php"><i class='glyphicon glyphicon-barcode'></i> Pagos</a></li>-->
      ...
      <ul class="nav navbar-nav navbar-right">
       <!-- <li><a href="http://geneticaavicola.com/" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Genetica Avicola</a></li> -->
