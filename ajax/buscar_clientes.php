<?php
	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> No se pudo eliminar éste  cliente. Existen fichas vinculadas a éste producto. 
			</div>
			<?php
		}
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$destino_cliente=$row['destino_cliente'];
						$consignatario1_cliente=$row['consignatario1_cliente'];
					...
					<input type="hidden" value="<?php echo $destino_cliente;?>" id="destino_cliente<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $consignatario1_cliente;?>" id="consignatario1_cliente<?php echo $id_cliente;?>">
					...
					<tr>
						...
						<td><?php echo $destino_cliente; ?></td>
						<td><?php echo $consignatario1_cliente; ?></td>
